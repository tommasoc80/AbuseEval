...
def read_and_match(comments, terms2):
    ...
    with open(comments, newline='') as csvfile:
        ...
        next(read_data) # OLID; HateEval Train
        counter = 0
...
if __name__ == '__main__':
    ...
    """
    offensive_comments_test = OffenseEval test data
    ...
    offensive_comments_test = "../abuseval_offenseval_test.tsv"
    ...
    read_and_match(offensive_comments_test,list_offensive_words4)